...
st.set_page_config(page_title="Medicano", layout="wide")
                ...
                if st.button("✅ Register"):
                    if new_password != confirm_password:
                        ...
                        if success:
                            ...
                            st.error("❌ " + msg)
# --------- Load Main App Only After Login ---------
if st.session_state.logged_in:
        ...
        def run(self):
            ...
            with st.sidebar:
                ...
                app_title = option_menu(
                    menu_title='Medicano',
                    options=titles,
                    icons=['house-fill', 'heart-pulse', 'capsule', 'info-circle', 'journal-text', 'geo-alt', 'exclamation-triangle-fill', 'bell'],
    ...
    Medical.add_apps("Pill Reminder", lambda: PillReminderApp())
